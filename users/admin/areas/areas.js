...
class AreasController {
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="d-flex align-items-center mb-4">
                            <div class="area-color me-3" style="background-color: ${detalles.color}; width: 30px; height: 30px;"></div>
                            <div>
    ...
    crearFilaArea(area, numero) {
        ...
        fila.innerHTML = `
            ...
            <td>
                <div class="d-flex align-items-center">
                    <div class="area-color" style="background-color: ${area.color || '#3498db'};"></div>
                    <div>
