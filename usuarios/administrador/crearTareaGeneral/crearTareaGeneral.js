// crearTareaGeneral.js - VERSIÓN PARA TAREAS GENERALES
// VISIBLE PARA TODOS LOS USUARIOS DE LA ORGANIZACIÓN

import { TareaManager } from '/clases/tarea.js';

// =============================================
// CLASE PRINCIPAL - CrearTareaGeneralController
// =============================================
class CrearTareaGeneralController {
    ...
    async _init() {
        try {
            console.log('🚀 Inicializando CrearTareaGeneralController...');
    ...
    _agregarItem() {
        ...
        itemRow.innerHTML = `
            ...
            <input type="text" class="item-input" placeholder="Ej: Revisar políticas" maxlength="200">
    ...
    async _guardarTarea(nombre, items) {
        ...
        try {
            ...
            // Crear objeto de datos de la tarea - tipo 'general'
            const tareaData = {
                nombreActividad: nombre,
                descripcion: descripcion,
                items: items,
                tipo: 'general'
                // No se incluyen usuariosCompartidosIds, areaId ni cargosIds
                // porque es visible para toda la organización
            };
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('📄 DOM cargado, iniciando controller de tarea general...');
